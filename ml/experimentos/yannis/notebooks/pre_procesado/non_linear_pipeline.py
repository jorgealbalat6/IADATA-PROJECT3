...
class TreePreprocessor(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y):
        ...
        print("🌲 [TreePreprocessor] Ejecutando fit: Seleccionando features...")
    ...
    def transform(self, X):
        ...
        # 3. Ensamblar lista de columnas a borrar (incluyendo el target por seguridad)
...
def build_tree_pipeline(cat_col: str = 'neighbourhood_cleansed',
    ...
    print("[Pipeline Árboles] Construido: TreePreprocessor (Sin escalado, NaNs nativos).")
    return pipeline